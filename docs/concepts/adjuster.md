...
objects for every shoot cluster of the seed. If number of Machines that `Failed` to join the cluster cross the `MachineFailureFractionThreshold` (configurable), 
